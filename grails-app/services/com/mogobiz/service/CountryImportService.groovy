...
class CountryImportService {
    ...
    void importAll() {
        File countries = new File(Holders.config.importCountries.dir)
        File admins1 = new File(Holders.config.importCountries.dir)
        File admins2 = new File(Holders.config.importCountries.dir)
        File cities = new File(Holders.config.importCountries.dir)
