...
public class DatabaseReader implements GeoIp2Provider, Closeable {
    ...
    public final static class Builder {
         ...
         *             {@link com.maxmind.db.Reader.FileMode#MEMORY}, but you provided a different
         ...
         * @throws java.io.IOException if there is an error reading the database
         */
     ...
     * @throws com.maxmind.geoip2.exception.AddressNotFoundException
